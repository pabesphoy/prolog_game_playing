...
next(cell(X, Y, P)) :-  Xup is X + 1,                        Xdown is X - 1,                        does(P, drop(Y)),                        height(X),                        column(Y),                        cellopen(Xup, Y),                        \+ cellopen(Xdown, Y).
...
line(Player) :-    cell(X1, Y, Player),    succ(X1, X2),    succ(X2, X3),    succ(X3, X4),    cell(X2, Y, Player),    cell(X3, Y, Player),    cell(X4, Y, Player).
line(Player) :-    cell(X, Y1, Player),    succ(Y1, Y2),    succ(Y2, Y3),    succ(Y3, Y4),    cell(X, Y2, Player),    cell(X, Y3, Player),    cell(X, Y4, Player).
line(Player) :-    cell(X1, Y1, Player),    succ(X1, X2),    succ(X2, X3),    succ(X3, X4),    succ(Y1, Y2),    succ(Y2, Y3),    succ(Y3, Y4),    cell(X2, Y2, Player),    cell(X3, Y3, Player),    cell(X4, Y4, Player).
line(Player) :-    cell(X1, Y4, Player),    succ(X1, X2),    succ(X2, X3),    succ(X3, X4),    succ(Y3, Y4),    succ(Y2, Y3),    succ(Y1, Y2),    cell(X2, Y3, Player),    cell(X3, Y2, Player),    cell(X4, Y1, Player).
succ(1, 2).
succ(2, 3).
succ(3, 4).
succ(4, 5).
