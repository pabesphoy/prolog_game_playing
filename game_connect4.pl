...
line(Player) :-        true(cell(M, N, Player)),        true(cell(M1, N, Player)),        true(cell(M2, N, Player)),        true(cell(M3, N, Player)),        M1 is M + 1,        M2 is M1 + 1,        M3 is M2 + 1;        true(cell(M, N, Player)),        true(cell(M, N1, Player)),        true(cell(M, N2, Player)),        true(cell(M, N3, Player)),        N1 is N + 1,        N2 is N1 + 1,        N3 is N2 + 1;        true(cell(M, N, Player)),        true(cell(M1, N1, Player)),        true(cell(M2, N2, Player)),        true(cell(M3, N3, Player)),        M1 is M + 1, N1 is N + 1,        M2 is M1 + 1, N2 is N1 + 1,        M3 is M2 + 1, N3 is N2 + 1;        true(cell(M, N, Player)),        true(cell(M1, N1, Player)),        true(cell(M2, N2, Player)),        true(cell(M3, N3, Player)),        M1 is M + 1, N1 is N - 1,        M2 is M1 + 1, N2 is N1 - 1,        M3 is M2 + 1, N3 is N2 - 1.
terminal :- line(red).
terminal :- line(black).
terminal :- \+ boardopen.
column(1).
